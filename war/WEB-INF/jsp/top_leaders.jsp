...
<html lang="en">
<head>
<title>GlamFiesta | Leaders</title>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="keywords" content="glamfiesta, fashionistas, leaders, youtube fashionistas, women style, women fashion">
<meta name="description" content="leaders fashionistas">
          ...
          <li><a href="/toplooks"><span class="fa fa-thumbs-o-up"></span>&nbsp;Top Looks</a></li>
			...
			<div class="col-sm-10">
                ...
                <h1>GlamFiesta - Get Noticed. Inspire Others.</h1>
                 <p class="lead">Top leader fashionistas </p>  
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-12">
								<ol class="breadcrumb">
									...
									<li class="active">Top Leaders</li>
								</ol>
														...
														<tr>
															<td>
																<div class="panel-thumbnail">
																	<a href="/fashionistas/${leader.account_username }"> <img
															...
															<td>
																<div class="text-left">
																	<p>
																		<strong><a
																			href="/fashionistas/${leader.account_username }">${leader.account_username }</a></strong>
																	</p>
																	<p>
																		<small><i class="fa fa-map-marker"></i>${leader.location }</small>
																	</p>
																	<div class="col-md-4 col-xs-4 follow" align="center">
																		<h3>
																			<strong>${leader.total_lookbooks}</strong> <br />
																			<span>Looks</span>
																		</h3>
																	</div>
																	<div class="col-md-4 col-xs-4 follow" align="center">
																		<h3>
																			<strong>${leader.total_followers }</strong> <br />
																			<span>Followers</span>
																		</h3>
																	</div>
																	<div class="col-md-4 col-xs-4 follow" align="center">
																		<h3>
																			<strong>${leader.total_glampoints }</strong> <br />
																			<span>Points</span>
																		</h3>
																	</div>
															...
															<td>
																<div class="right">
																	<c:if test="${not empty leader.lookbookList }">
																		<div class="row">
																			<ul class="list-inline">
																				<c:forEach items="${leader.lookbookList }"
																					var="latestlook">
																					<li>
																						<div class="panel-thumbnail">
																							<a
