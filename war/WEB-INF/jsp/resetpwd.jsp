...
<html lang="en">
<head>
<title>GlamFiesta | Reset Password page </title>
<meta charset="utf-8">
						    ...
						    <div class="signinpanel">
						        ...
						        <div class="row">
						            ...
						            <div class="col-sm-8 col-md-3 col-lg-6">
											...
											<form:form modelAttribute="resetform" method="POST" action="/resetpwd">
											
						                    <h4 class="nomargin">Reset Password</h4>
						                    <p><small>Enter your registered username,email id & the reset auth key we sent to your emailid to reset your password.</small></p>
											...
											<form:input type="text" path="account_username" class="form-control" placeholder="Please Enter Username" />
						                    <form:input type="text" path="account_email" class="form-control" placeholder="Please Enter Emailid" />
						                    <form:input type="password" path="reset_key" class="form-control" placeholder="Please Enter Auth Key" />
						                    <form:input type="password" path="account_password" class="form-control" placeholder="Your New Password" />
						                    <input type="submit" class="btn btn-red btn-block" value="Validate & Update Password">
