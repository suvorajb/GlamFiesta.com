        		...
        		<!-- dashboard main content page -->
				    <!-- Topic Header -->
					  ...
					  <div class="profile-header">
						<h2 class="profile-name">Manage Your Interview</h2>
						<div class="profile-location"><i class="fa fa-arrow-right"></i> Save interview of the fashionistas
						</div>
					  </div><!-- profile-header -->
                      ...
                      <c:if test="${not empty succsmssg }">
						...
						<form:form modelAttribute="interviewform" method="POST" action="/mnda/intrvw">
							
							<div class="panel panel-default">
								<div class="panel-body">
								
									<div class="form-group">
									  <div class="col-sm-12"><label>Fashionista Username</label>
									  	<form:input type="text" path="usernm" class="form-control" />
									  </div>
									</div>
									
									
									<div class="form-group">
									  <div class="col-sm-12"><label>Interview Title</label>
									  	<form:input type="text" path="intrvwtitle" class="form-control" />
									  </div>
									</div>
									...
									<div class="form-group">
									  <div class="col-sm-12">
										<label>Interview Section 1: </label>
										<form:textarea path="intrvwtxt1" rows="5" class="form-control" />
									  </div>
									</div>	
									<div class="form-group">
									  <div class="col-sm-12"><label>Fashion photo1</label>
									  	<form:input type="text" path="fshnphoto1" class="form-control" />
									  </div>
									</div>
									
									<div class="form-group">
									  <div class="col-sm-12">
										<label>Interview Section 2: </label>
										<form:textarea path="intrvwtxt2" rows="5" class="form-control" />
									  </div>
									</div>	
									<div class="form-group">
									  <div class="col-sm-12"><label>Fashion photo2</label>
									  	<form:input type="text" path="fshnphoto2" class="form-control" />
									  </div>
									</div>
									
																																				<div class="form-group">
									  <div class="col-sm-12">
										<label>Interview Section 3: </label>
										<form:textarea path="intrvwtxt3" rows="5" class="form-control" />
									  </div>
									</div>	
									<div class="form-group">
									  <div class="col-sm-12"><label>Fashion photo3</label>
									  	<form:input type="text" path="fshnphoto3" class="form-control" />
									  </div>
									</div>
