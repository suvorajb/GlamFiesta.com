				...
				<div class="row">
					<div class="col-xs-12">
									...
									<div class="col-sm-6">
										<h3>
											<a href="/dashboard/updtprofile"
												...
												class="btn btn-sm btn-red text-right">Followers /
												Following</a>
										</h3>
									</div>
								</div>
						...
						<ul class="nav nav-tabs nav-justified ">
							<li><a href="#outfits" data-toggle="tab"><strong>My
										Lookbook</strong></a></li>
						</ul>
						...
						<div class="tab-pane" id="outfits">
							<div class="outfits">
								<h4 class="subtitle">
									My Style and Lookbooks gallery <a
										href="/dashboard/lookbook/postnew"
										class="pull-right btn btn-sm btn-danger"> Post A new Look</a>
								</h4>
								<div class="row">
													...
													<div>
														<p>
															<a
																...
																src="${lookbook.gcs_photo_url1 }" class="img-responsive"></a>
														</p>
														<h4>
															<a
																href="/fashion/${lookbook.lookbook_seo_url}">${lookbook.lookbookname }</a>
														</h4>
														<p>
															<c:if test="${lookbook.lookbook_publish_status == 'Yes'}">
																<span class="label label-primary">Published</span>
															</c:if>
															<c:if test="${lookbook.lookbook_publish_status == 'No'}">
																<span class="label label-danger">Not Published</span>
															</c:if>
															<c:if test="${lookbook.isrejected == true}">
																<span class="label label-danger">Rejected</span>
															</c:if>
														</p>
														<p>
															<c:if test="${lookbook.can_edit == true }">
																<a
																	href="/dashboard/lookbook/manage?lookbookid=${lookbook.lookbookid }"
																	class="btn btn-sm btn-red">Manage Lookbook</a>
															</c:if>
														</p>
													</div>
												</div>
									...
									<c:if test="${empty lookbooks}">
										<div class="col-sm-10 col-xs-10 col-md-10 col-lg-10">
											<p>You do not have any looks yet, share your look and
												discover the fashionista in you...</p>
										</div>
									</c:if>
