...
<title>GlamFiesta | Dashboard - Update Profile information</title>
<!-- Bootstrap core CSS -->
					...
					<div class="col-xs-12">
						...
						<div class="panel panel-default">
							<div class="panel-body">
								<form:form modelAttribute="avatarform" method="POST"
									action="${avatarUploadUrl}" enctype="multipart/form-data">
									<div class="row">
										<div class="col-sm-4">
						...
						<ul class="nav nav-tabs nav-justified ">
							<li class="active"><a href="#profile" data-toggle="tab"><strong>Update
										Profile</strong></a></li>
							<li><a href="#pwd" data-toggle="tab"><strong>Change
						...
						<div class="tab-content">
										...
										<div class="panel-body">
											...
											<div class="form-group">
												<div class="col-sm-6">
													...
													<form:input type="text" path="first_name"
														class="form-control" placeholder="Type your first name..." />
												</div>
												<div class="col-sm-6">
													<label>Last Name </label>
													<form:input type="text" path="last_name"
														class="form-control" placeholder="Type your last name..." />
												</div>
											</div>
											...
											<div class="form-group">
												<div class="col-sm-12">
													...
													<form:textarea path="aboutme" rows="5" class="form-control"
														placeholder="Describe in few words about you..." />
												</div>
											</div>
											...
											<div class="form-group">
												<div class="col-sm-12">
													...
													<form:input type="text" path="citynm" class="form-control"
											...
											<div class="form-group">
												<div class="col-sm-12">
													<label>Where others can find you?</label><br /> <label><i
														class="fa fa-twitter"></i> Twitter Profile</label>
													<form:input type="text" path="twitter_ac"
														class="form-control"
														placeholder="Type your Twitter account url" />
													<br /> <label><i class="fa fa-facebook"></i>
														Facebook Page/Profile</label>
													<form:input type="text" path="facebook_ac"
														class="form-control" placeholder="Type your Facebook url" />
													<br /> <label><i class="fa fa-google-plus"></i>
														Google+ Profile/Page </label>
													<form:input type="text" path="google_plus_ac"
														class="form-control"
														placeholder="Type your Google+ channel name" />
													<br /> <label><i class="fa fa-youtube"></i> Youtube
														Channel </label>
													<form:input type="text" path="youtube_ac"
														class="form-control"
														placeholder="Type your Youtube channel name" />
													<br /> <label><i class="fa fa-linkedin"></i>
														Linkedin professional Profile/Page</label>
													<form:input type="text" path="linkedin_ac"
														class="form-control"
														placeholder="Type your Linkedin profile" />
													<br /> <label><i class="fa fa-pinterest"></i>
														Pinterest Board</label>
													<form:input type="text" path="pinterest_ac"
														class="form-control"
														placeholder="Type your Pinterest board url" />
													<br /> <label><i class="fa fa-instagram"></i>
														Instagram Profile</label>
													<form:input type="text" path="instagram_ac"
														class="form-control"
														placeholder="Type your Instagram profile url" />
													<br /> <label><i class="fa fa-tumblr"></i> Tumblr
														Page</label>
													<form:input type="text" path="tumblr_ac"
														class="form-control"
														placeholder="Type your Tumblr profile url" />
													<br /> <label><i class="fa fa-wordpress"></i>
														Blog/Website</label>
													<form:input type="text" path="website_blog_url"
														class="form-control"
														placeholder="Type your Blor or website url" />
													<br />
												</div>
											</div>
							...
							<div class="tab-pane" id="pwd">
								<form:form modelAttribute="pwdform" method="POST"
									action="/dashboard/updtpwd">
										...
										<div class="panel-body">
											...
											<div class="form-group">
												<div class="col-sm-6">
													...
													<form:input type="text" path="account_password"
														class="form-control" />
												</div>
											</div>
