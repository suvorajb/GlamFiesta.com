        		...
        		<!-- dashboard main content page -->
				    <!-- Topic Header -->
				      <div class="topic">
				        <div class="container">
				          <div class="row">
				            <div class="col-sm-6"><h3>Manage Global Tags</h3></div>
				            <div class="col-sm-6">
				            	<ol class="breadcrumb">
					  ...
					  <div class="profile-header">
						<h2 class="profile-name">Manage Global Tags</h2>
                      ...
                      <c:if test="${not empty succsmssg }">
						...
						<form:form modelAttribute="mscForm" method="POST" action="/mnda/lkbk/glbltags">
							
							<div class="panel panel-default">
								<div class="panel-body">
								
									<div class="form-group">
									  <div class="col-sm-12"><label>Tags <span class="asterisk">*</span></label>
									  	<form:input type="text" path="editor_picks_glbltags" class="form-control"/>
									  </div>
									</div> 
									...
									<div class="form-group">
										  <div class="col-sm-12">
											<div  class="well">
												<form:radiobutton path="frmaction" value="Add"/>  Add this tag<br/>
												<form:radiobutton path="frmaction" value="Del"/>  Delete this tag<br/>
											</div>
										  </div>
									</div>
									
									<div class="form-group">
									  <div class="col-sm-12"><label>Tags Description</label>
									  	<form:textarea path="editor_picks_glbltags_desc" rows="5" class="form-control" />
									  </div>
									</div>
