...
<html lang="en">
<head>
<title>GlamFiesta | Contact Us</title>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="glamfiesta contact us">
			...
			<nav class="col-sm-2">
				...
				<div class="row">
					...
					<ul class="nav nav-pills nav-stacked menu">
						...
						<li class="selectd"><a href="/contactus.htm"><span
							...
							<div class="col-md-9">
								...
								<div class="panel panel-default">
									<div class="panel-body">
										<h4>Contact Us</h4>
										<p>
											We like to hear how we are doing. Please reach us if you have
											any question, feedback, concern or just want to say "Hi" at <strong>editor.glamfiesta[At]gmail.com
												(replace [At] with @)</strong>
										</p>
									</div>
								</div>
							</div>
