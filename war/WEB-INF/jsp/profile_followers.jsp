...
<html lang="en">
<head>
<title>GlamFiesta | Social Connections & followers </title>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="keywords" content="glamfiesta, ${usrbo.account_username } profile">
<meta name="description" content="${usrbo.account_username }'s profile followers">
											...
											<c:forEach items="${followers}" var="follower">
												...
												<div class="col-sm-6 col-xs-6 col-md-4 col-lg-4">
													<div class="thumbnail card">
															<div align="center">
													            <div class="line"><h4><a href="/fashionistas/${follower.account_username }">${follower.account_username }</a></h4></div>
													            <p><a href="/fashionistas/${follower.account_username }"><img src="${follower.uavatar }" class="img-responsive image-circle"/></a></p>   
													            <small>From <strong>${follower.location }</strong></small>
														    </div>
									                    <p>&nbsp;</p>
													</div>
												</div>						
							...
							<div class="row">
								...
								<h4 class="headline"><span>Share Love</span></h4>
									<p>	<a href="http://twitter.com/?status=http://www.glamfiesta.com/fashionistas/${usrbo.account_username}" title="Share on Twitter" target="_blank" data-toggle="tooltip" data-placement="top" class="btn btn-twitter"><i class="fa fa-2x fa-twitter"></i></a> 
										...
										<a href="http://www.stumbleupon.com/submit?url=http://www.glamfiesta.com/${usrbo.account_username}" title="Share on StumbleUpon" target="_blank" data-toggle="tooltip" data-placement="top" class="btn btn-stumbleupon"><i class="fa fa-2x fa-stumbleupon"></i></a>
