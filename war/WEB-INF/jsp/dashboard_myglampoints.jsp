				...
				<div class="row">
					<div class="col-xs-12">
						...
						<ul class="nav nav-tabs nav-justified ">
							<li><a href="#gpoints" data-toggle="tab"><strong>My
										Points</strong></a></li>
						</ul>



						<div class="tab-pane" id="gpoints">
							<!--  ************ glam points history ************ -->
							<h4 class="subtitle">Total Glam Points earned -
								${usrbo.total_glampoints }</h4>
							<div class="activity-list">
								<c:if test="${not empty gpoints_hsts }">
									<c:forEach items="${gpoints_hsts }" var="gpoints_hst">
										<div class="media act-media">
											<a class="pull-left" href="/${usrbo.account_username }/">
												<img class="media-object act-thumb" src="${usrbo.uavatar }"
												width="60px" />
											</a>
											<div class="media-body act-media-body">
												<strong>${gpoints_hst}</strong> <br />
											</div>
										</div>
										<!-- media -->
									</c:forEach>
