        		...
        		<!-- dashboard main content page -->
				    <!-- Topic Header -->
				      <div class="topic">
				        <div class="container">
				          <div class="row">
				            <div class="col-sm-6"><h3>Manage Lookbook to Global Tags</h3></div>
				            <div class="col-sm-6">
				            	<ol class="breadcrumb">
					  ...
					  <div class="profile-header">
						<h2 class="profile-name">Manage Your Lookbook to Global Tags</h2>
							...
							<div class="panel panel-default">
								<div class="panel-body">
									...
									<div class="form-group">
									  <div class="col-sm-12"><label>Global Taglist</label>
									  	<form:select path="editor_picks_lkbk_glbltag" items="${taglist}"/>
									  </div>
									</div> 
									
									<div class="form-group">
									  <div class="col-sm-12"><label>Lookbook Ids</label>
									  	<form:textarea path="editor_picks_lkbk_ids" rows="5" class="form-control" />
									  </div>
									</div>
