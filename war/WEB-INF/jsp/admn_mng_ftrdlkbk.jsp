...
<title>Admin featured lookbook</title>
<!-- Bootstrap core CSS -->
        		...
        		<!-- dashboard main content page -->
				    <!-- Topic Header -->
                      ...
                      <c:if test="${not empty succsmssg }">
						...
						<form:form modelAttribute="lkbkform" method="POST" action="/mnda/ftrdlkbk">
							
							<div class="panel panel-default">
								<div class="panel-body">
								
									<div class="form-group">
									  <div class="col-sm-12"><label>Enter lookbookid</label>
									  	<form:input type="text" path="lookbookid" class="form-control" />
									  </div>
									</div>
									
									<div class="form-group">
									  <div class="col-sm-12"><label>Global Tag</label>
