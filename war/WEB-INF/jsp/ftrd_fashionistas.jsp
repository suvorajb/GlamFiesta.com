...
<title>GlamFiesta | Featured Fashionistas </title>
<!-- Bootstrap core CSS -->
    ...
    <nav class="col-sm-2"><!--nav-->
      <div class="row">    
        ...
        <ul class="nav nav-pills nav-stacked menu">
          ...
          <li class="selectd"><a href="/fashionistas"><span class="fa fa-users"></span>&nbsp;Fashionistas</a></li>
          ...
          <div class="col-xs-12">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <p class="lead">Featured Fashionistas</p> 
              </div>
            </div>
            ...
            <div class="row">
        		<div class="col-md-9">
        			<ol class="breadcrumb">
					    ...
					    <li class="active">Featured Fashionista</li>
					</ol>
					
					<c:if test="${not empty ftrdFashionista }">
		        			<div class="panel">
									...
									<ul class="list-group">
					                        ...
					                        <div class="row">
					                            <div class="col-xs-3 col-md-3">
					                                <a href="/fashionistas/${ftrdFashionista.account_username}">
					                                	<img src="${ftrdFashionista.uavatar }" class="img-responsive" alt="${ftrdFashionista.account_username}" />
					                                </a>
										            <h4>
										                 <strong>${ftrdFashionista.total_glampoints}</strong> <span>GLAM POINTS</span>
										            </h4>
										        </div>
					                            <div class="col-xs-9 col-md-9">
				                                    <div class="mic-info">
				                                        <h1><a href="/fashionistas/${ftrdFashionista.account_username}">${ftrdFashionista.account_username}</a></h1>
				                                           <div class="ftrd">
					                                           <blockquote>
							                                        <div class="row">
							                                            <div class="col-sm-8 col-sm-offset-2">
							                                                ${ftrdFashionista.note_from_editor}
							                                                <small>A note from GlamFiesta Editor</small>
							                                            </div>
							                                        </div>
							                                   </blockquote>
						                                   </div>
					                                ...
					                                <div class="comment-text">
					                                    <h4><a href="http://${ftrdFashionista.fashion_blog_url1 }" target="_blank">${ftrdFashionista.fashion_blog_url1 }</a></h4>
					                                </div>
		        			...
		        			<c:if test="${not empty ftrdFashionista.youtube_video_url1 }">
			        			<div class="panel panel-default">
									<div class="panel-body">
										<h4 class="headline"><span>Popular videos from ${ftrdFashionista.account_username }'s Youtube Channel</span></h4>
											<div class="row">
        			...
        			<c:if test="${empty ftrdFashionista }">
							<div class="alert alert-danger alert-dismissible" role="alert">
	  							<c:out value="${errormssg}"/>
							</div>
        			</c:if>
...
<c:if test="${not empty ftrdFashionista.youtube_video_url1 }">
	...
	$('#youtbe1').html('<iframe width="300" height="250"  src="//www.youtube.com/embed/' + vidId1 + '" frameborder="0" allowfullscreen></iframe>');	
</c:if>

<c:if test="${not empty ftrdFashionista.youtube_video_url2 }">
	var vidId2 = getId('${ftrdFashionista.youtube_video_url2 }');
	$('#youtbe2').html('<iframe width="300" height="250"  src="//www.youtube.com/embed/' + vidId2 + '" frameborder="0" allowfullscreen></iframe>');	
</c:if>

<c:if test="${not empty ftrdFashionista.youtube_video_url3 }">
	var vidId3 = getId('${ftrdFashionista.youtube_video_url3 }');
	$('#youtbe3').html('<iframe width="600" height="350" src="//www.youtube.com/embed/' + vidId3 + '" frameborder="0" allowfullscreen></iframe>');	
</c:if>
</script>
<script>
