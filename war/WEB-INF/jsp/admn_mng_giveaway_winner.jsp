        		...
        		<!-- dashboard main content page -->
				    <!-- Topic Header -->
				      <div class="topic">
				        <div class="container">
				          <div class="row">
				            <div class="col-sm-6"><h3>Manage Giveaway Winner</h3></div>
				            <div class="col-sm-6">
				            	<ol class="breadcrumb">
					  ...
					  <div class="profile-header">
						<h2 class="profile-name">Manage Giveaway Winner</h2>
						</div>
					  </div><!-- profile-header -->
                      ...
                      <c:if test="${not empty succsmssg }">
						...
						<form:form modelAttribute="giveawaywinnerform" method="POST" action="/mnda/giveaway/">
							
							<div class="panel panel-default">
								<div class="panel-body">
								
									<div class="form-group">
									  <div class="col-sm-12"><label>Username</label>
									  	<form:input type="text" path="username" class="form-control"/>
									  </div>
									</div>
									
									<div class="form-group">
									  <div class="col-sm-12"><label>Date of Winning <span class="asterisk">*</span></label>
									  	<form:input type="text" path="date_of_winning" class="form-control"/>
									  </div>
									</div>
									
									<div class="form-group">
									  <div class="col-sm-12"><label>Rewards Amount <span class="asterisk">*</span></label>
									  	<form:input type="text" path="giveaway_rewards_amnt" class="form-control"/>
									  </div>
									</div>
									
									<div class="form-group">
									  <div class="col-sm-12"><label>Winning Lookbook URL1 <span class="asterisk">*</span></label>
									  	<form:input type="text" path="lookbook_winning_url1" class="form-control"/>
									  </div>
									</div>									
										
									
									<div class="form-group">
										<div class="col-sm-12"><label>Winning Lookbook URL2 </label><br/>
											<form:input type="text" path="lookbook_winning_url2" class="form-control" />
										</div>
									</div>
