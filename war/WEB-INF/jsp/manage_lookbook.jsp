...
<title>GlamFiesta | Dashboard manage lookbook... </title>
<!-- Bootstrap core CSS -->
        		...
        		<!-- dashboard main content page -->
				    <!-- Topic Header -->
					  ...
					  <div class="profile-header">
						...
						<form:form modelAttribute="lookbookform" method="POST" action="/dashboard/lookbook/manage">
								...
								<div class="panel-body">
									...
									<div class="form-group">
									  <div class="col-sm-12"><label>Lookbook title <span class="asterisk">*</span></label>
									  	<form:input type="text" path="lookbookname" class="form-control"/>
									  </div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-12"><label>Tags <span class="asterisk">*</span></label><br/>
											<form:input type="text" path="tags" class="form-control"  data-role="tagsinput" />
											<span class="help-block">Press Enter after every tag/keyword</span>
										</div>
									</div>
									...
									<div class="form-group">
									  <div class="col-sm-12">
										...
										<form:textarea path="lookbookstory" rows="5" class="form-control" />
									...
									<div class="form-group">
										<div class="col-sm-12"><label>Youtube Lookbook/OOTD glam video:</label><br/>
											<form:input type="text" path="lookbook_youtube_videourl" class="form-control" />
										</div>
									</div>
