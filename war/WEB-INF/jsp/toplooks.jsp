...
<html lang="en">
<head>
<title>GlamFiesta | Top Featured Looks </title>

<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Top featured looks selected by GlamFiesta Editor">
    ...
    <nav class="col-sm-2"><!--nav-->
      <div class="row">    
        ...
        <ul class="nav nav-pills nav-stacked menu">
          ...
          <li class="selectd"><a href="/toplooks"><span class="fa fa-thumbs-o-up"></span>&nbsp;Top Looks</a></li>
          ...
          <div class="col-xs-12">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <p class="lead">Editor's Choice Top Looks</p>  
              </div>
            </div>
            ...
            <div class="row">
        		<div class="col-md-12">
							...
							<h2>
								<c:forEach items="${globaltags }" var="globaltag">
									<c:if test="${globaltag != currtag }">
										<a href="/toplooks?tag=${globaltag}">#${globaltag}</a>
									</c:if>
									<c:if test="${globaltag == currtag }">
										<b>#${globaltag}</b>
									</c:if>
					...
					<c:if test="${not empty featuredlooks }">
						<div id="grid" class="container">
							<div id="posts">
								<c:forEach items="${featuredlooks}" var="lookbook">
									<div class="post">
										<a href="/fashion/${lookbook.usrinfo.account_username}/lookbook/view/${lookbook.lookbookid}/${lookbook.lookbook_seo_url}" target="_blank">
											${lookbook.lookbookname }
										</a>
										<a href="/u/${lookbook.usrinfo.account_username}/lookbook/view/${lookbook.lookbookid}/${lookbook.lookbook_seo_url}" target="_blank">
