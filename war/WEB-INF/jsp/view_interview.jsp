									...
									<div class="col-md-12">
										<div class="panel panel-default">
											<div class="panel-body">
												<c:if test="${not empty intrvw.fshnphoto1 }">
													<div class="row">
														<div class="col-md-12">
															<img src="${intrvw.fshnphoto1 }"
												...
												<c:if test="${not empty intrvw.intrvwtxt1 }">
													<div class="row">
														<div class="col-md-12">
															<p>${intrvw.intrvwtxt1 }</p>
														</div>
														<!-- //col-md-12 -->
													</div>
												</c:if>

												<c:if test="${not empty intrvw.fshnphoto2 }">
													<div class="row">
														<div class="col-md-12">
															<img src="${intrvw.fshnphoto2 }"
																class="img-responsive center-block"
																onContextMenu="return false;">
														</div>
														<!-- //col-md-12 -->
												...
												<c:if test="${not empty intrvw.intrvwtxt2 }">
													<div class="row">
														<div class="col-md-12">
															<p>${intrvw.intrvwtxt2 }</p>
														</div>
														<!-- //col-md-12 -->
													</div>
												</c:if>
												...
												<c:if test="${not empty intrvw.fshnphoto3 }">
													<div class="row">
														<div class="col-md-12">
															<img src="${intrvw.fshnphoto3 }"
																class="img-responsive center-block"
																onContextMenu="return false;">
														</div>
														<!-- //col-md-12 -->
												...
												<c:if test="${not empty intrvw.intrvwtxt3 }">
													<div class="row">
														<div class="col-md-12">
															<p>${intrvw.intrvwtxt3 }</p>
														</div>
														<!-- //col-md-12 -->
													</div>
												</c:if>
													...
													<c:forEach items="${intervwlist}" var="interview">
														<li>
															<div class="row">
																...
																<div class="col-xs-9">
																	<a href="/interviews/${interview.intrvw_seo_title}">
																		<span class="fashionista clearfix name"> <strong>${interview.intrvwtitle }</strong>
																	</span>
																	</a>
																</div>
															</div>
